...
local function OnInitialize()
    ...
    Components.Window({
        ...
        OnInitialize = function(self)
            ...
            local childList = {}
            Utils.Array.ForEach(FILTER_KEYS, function(entry)
                Utils.Array.Add(childList, filterButtons[entry.key])
            end)
            Utils.Array.Add(childList, timestampBtn)
            Utils.Array.Add(childList, alphaDecrBtn)
            Utils.Array.Add(childList, alphaIncrBtn)
            Utils.Array.Add(childList, logDisplay)
            Utils.Array.Add(childList, channelBtn)
            Utils.Array.Add(childList, textInput)
