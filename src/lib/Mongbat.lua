...
---
--- Returns a wrapper for a skill's dynamic data by server ID.
---@param serverId number The server skill ID (0-based).
...
---
--- Returns the raw SkillsCSV table (keyed by csvId 1..N).
--- Each entry has: ServerId, NameTid, and other skill definition fields.
---@return table?
...
---@field OnUpdateSkillDynamicData fun(self: Window, skillData: SkillDynamicDataWrapper)?
...
---@field OnUpdateSkillDynamicData fun(self: View, skillData: SkillDynamicDataWrapper)?
...
function View:onUpdateSkillDynamicData()
    if self._model.OnUpdateSkillDynamicData ~= nil then
        self._model.OnUpdateSkillDynamicData(self, Data.SkillDynamicData(self:getId()))
        return true
    end
    return false
end
